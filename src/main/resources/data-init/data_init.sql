...
- Экран (приятная цветопередача, читать комфортно, повышенная герцовка в первые разы восхищала).', 5, 2),
    ...
    '2023-09-13 18:20:03', true, '- Размер (разумный - достаточно большой для чтения/просмотра контента, но не чрезмерный)
- Камера (первое время режимом "мультикадр" был приятно удивлён + мегапикселей не пожалели на основную камеру, зум работает увереннее, чем у конкурентов)
- Экран (приятная цветопередача, читать комфортно, повышенная герцовка в первые разы восхищала).', 15, 2),
       (7, 4, 'Добрый день! Благодарим Вас за отзыв, рады быть полезными. Спасибо, что выбираете нас. Хорошего дня!',
        '2023-09-13 18:20:03', true, '- Размер (разумный - достаточно большой для чтения/просмотра контента, но не чрезмерный)
- Камера (первое время режимом "мультикадр" был приятно удивлён + мегапикселей не пожалели на основную камеру, зум работает увереннее, чем у конкурентов)
- Экран (приятная цветопередача, читать комфортно, повышенная герцовка в первые разы восхищала).', 15, 2),
       (8, 5, 'Добрый день! Благодарим Вас за отзыв, рады быть полезными. Спасибо, что выбираете нас. Хорошего дня!',
        '2023-09-13 18:20:03', true, '- Размер (разумный - достаточно большой для чтения/просмотра контента, но не чрезмерный)
- Камера (первое время режимом "мультикадр" был приятно удивлён + мегапикселей не пожалели на основную камеру, зум работает увереннее, чем у конкурентов)
- Экран (приятная цветопередача, читать комфортно, повышенная герцовка в первые разы восхищала).', 14, 2),
