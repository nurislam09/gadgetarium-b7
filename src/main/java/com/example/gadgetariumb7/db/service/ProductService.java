...
public interface ProductService {
    ...
    List<ProductCardResponse> filterByParameters(String categoryName, String fieldSort, String discountField, String subCategoryName, Integer minPrice, Integer maxPrice, List<String> colors, Integer memory, Byte ram, int size);
